...
if __name__ == "__main__":
    ...
    analysis_folder_name = "new_rewards_for_multi_action_selection" # CHANGE ITTTTTTTT
    ag_paths = ["_AGC_sandbox_D3QN_DiReward_(default)"]
    short_names = ["D3QN (diRew)"] # "DoNothing", "ExpertSystem"
    notes = [
        "DiReward. Reduced actions. 3 frames. Rho, prod_p and time as observations. 25k training iterations"
        ]
